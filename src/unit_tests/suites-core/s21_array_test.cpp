...
void checkBasicFieldEmpty(const s21::array<T, N>& actual, const std::array<T, N>& expected) {
...
template <typename T, std::size_t N>
void checkBasicField(const s21::array<T, N>& actual, const std::array<T, N>& expected) {
  EXPECT_EQ(actual.size(), expected.size());
...
template <typename T, std::size_t N>
void checkBasicField(const s21::array<T, N>& actual, const s21::array<T, N>& expected) {
  EXPECT_EQ(actual.size(), expected.size());
  EXPECT_NE(actual.data(), expected.data());
...
TEST(suiteName, uShortCopyInit) { arrayCopyInitTest<unsigned short>(DEF_INT_VALS); } \
...
TEST(suiteName, MockClassCopyInit) { arrayCopyInitTest<MockClass>(DEF_MOCK_VALS); } \
TEST(suiteName, stringCopyInit) { arrayCopyInitTest<std::string>(DEF_STR_VALS); } \
...
TEST(suiteName, uShortOperatorCopy) { arrayOperatorCopyTest<unsigned short>(DEF_INT_VALS); } \
TEST(suiteName, intOperatorCopy) { arrayOperatorCopyTest<int>(DEF_INT_VALS); } \
TEST(suiteName, doubleOperatorCopy) { arrayOperatorCopyTest<double>(DEF_DBL_VALS); } \
TEST(suiteName, MockClassOperatorCopy) { arrayOperatorCopyTest<MockClass>(DEF_MOCK_VALS); } \
TEST(suiteName, stringOperatorCopy) { arrayOperatorCopyTest<std::string>(DEF_STR_VALS); } \
...
TEST(suiteName, uShortFront) { arrayFrontTest<unsigned short>(DEF_INT_VALS); } \
TEST(suiteName, intFront) { arrayFrontTest<int>(DEF_INT_VALS); } \
TEST(suiteName, doubleFront) { arrayFrontTest<double>(DEF_DBL_VALS); } \
TEST(suiteName, MockClassFront) { arrayFrontTest<MockClass>(DEF_MOCK_VALS); } \
...
TEST(suiteName, uShortOperatorCopyInitSelt) { arrayOperatorInitCopySelfTest<unsigned short>(DEF_INT_VALS); } \
TEST(suiteName, intOperatorCopyInitSelt) { arrayOperatorInitCopySelfTest<int>(DEF_INT_VALS); } \
TEST(suiteName, doubleOperatorCopyInitSelt) { arrayOperatorInitCopySelfTest<double>(DEF_DBL_VALS); } \
TEST(suiteName, MockClassOperatorCopyInitSelt) { arrayOperatorInitCopySelfTest<MockClass>(DEF_MOCK_VALS); } \
TEST(suiteName, stringOperatorCopyInitSelt) { arrayOperatorInitCopySelfTest<std::string>(DEF_STR_VALS); } \
...
TEST(suiteName, uShortOperatorMoveSelfInit) { arrayOperatorInitMoveSelfTest<unsigned short>(DEF_INT_VALS); } \
TEST(suiteName, intOperatorMoveSelfInit) { arrayOperatorInitMoveSelfTest<int>(DEF_INT_VALS); } \
TEST(suiteName, doubleOperatorMoveSelfInit) { arrayOperatorInitMoveSelfTest<double>(DEF_DBL_VALS); } \
TEST(suiteName, MockClassOperatorMoveSelfInit) { arrayOperatorInitMoveSelfTest<MockClass>(DEF_MOCK_VALS); } \
TEST(suiteName, stringOperatorMoveSelfInit) { arrayOperatorInitMoveSelfTest<std::string>(DEF_STR_VALS); } \
