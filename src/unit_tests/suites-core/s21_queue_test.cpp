...
template <typename T>
void checkBasicField(const s21::queue<T>& actual, const std::queue<T>& expected) {
  EXPECT_EQ(actual.size(), expected.size());
  EXPECT_EQ(actual.empty(), expected.empty());
}

template <typename T>
void checkBasicField(const s21::queue<T>& actual, const s21::queue<T>& expected) {
  EXPECT_EQ(actual.size(), expected.size());
  EXPECT_EQ(actual.empty(), expected.empty());
}
...
TEST(suiteName, uShortEmptyInitAsCont) { queueDefaultInitAsContTest<unsigned short>(); } \
TEST(suiteName, intEmptyInitAsCont) { queueDefaultInitAsContTest<int>(); } \
TEST(suiteName, doubleEmptyInitAsCont) { queueDefaultInitAsContTest<double>(); } \
TEST(suiteName, MockClassEmptyInitAsCont) { queueDefaultInitAsContTest<MockClass>(); } \
TEST(suiteName, stringEmptyInitAsCont) { queueDefaultInitAsContTest<std::string>(); } \
TEST(suiteName, NoConstructClassEmptyInitAsCont) { queueDefaultInitAsContTest<NoConstructClass>(); } \
...
TEST(suiteName, NoConstructClassEmptyInit) { queueDefaultInitTest<NoConstructClass>(); } \
...
TEST(suiteName, uShortListInit) { queueListInitTest<unsigned short>(DEF_INT_VALS); } \
...
TEST(suiteName, MockClassListInit) { queueListInitTest<MockClass>(DEF_MOCK_VALS); } \
TEST(suiteName, stringListInit) { queueListInitTest<std::string>(DEF_STR_VALS); } \
TEST(suiteName, NoConstructClassListInit) { queueListInitTest<NoConstructClass>(DEF_INT_VALS); } \
...
TEST(suiteName, uShortCopyInit) { queueCopyInitTest<unsigned short>(DEF_INT_VALS); } \
...
TEST(suiteName, MockClassCopyInit) { queueCopyInitTest<MockClass>(DEF_MOCK_VALS); } \
TEST(suiteName, stringCopyInit) { queueCopyInitTest<std::string>(DEF_STR_VALS); } \
TEST(suiteName, NoConstructClassCopyInit) { queueCopyInitTest<NoConstructClass>(DEF_INT_VALS); } \
...
TEST(suiteName, uShortMoveInit) { queueMoveInitTest<unsigned short>(DEF_INT_VALS); } \
...
TEST(suiteName, MockClassMoveInit) { queueMoveInitTest<MockClass>(DEF_MOCK_VALS); } \
TEST(suiteName, stringMoveInit) { queueMoveInitTest<std::string>(DEF_STR_VALS); } \
TEST(suiteName, NoConstructClassMoveInit) { queueMoveInitTest<NoConstructClass>(DEF_INT_VALS); } \
...
TEST(suiteName, uShortOperatorCopy) { queueOperatorCopyTest<unsigned short>(DEF_INT_VALS); } \
TEST(suiteName, intOperatorCopy) { queueOperatorCopyTest<int>(DEF_INT_VALS); } \
TEST(suiteName, doubleOperatorCopy) { queueOperatorCopyTest<double>(DEF_DBL_VALS); } \
TEST(suiteName, MockClassOperatorCopy) { queueOperatorCopyTest<MockClass>(DEF_MOCK_VALS); } \
TEST(suiteName, stringOperatorCopy) { queueOperatorCopyTest<std::string>(DEF_STR_VALS); } \
...
TEST(suiteName, uShortOperatorMove) { queueOperatorMoveTest<unsigned short>(DEF_INT_VALS); } \
TEST(suiteName, intOperatorMove) { queueOperatorMoveTest<int>(DEF_INT_VALS); } \
TEST(suiteName, doubleOperatorMove) { queueOperatorMoveTest<double>(DEF_DBL_VALS); } \
TEST(suiteName, MockClassOperatorMove) { queueOperatorMoveTest<MockClass>(DEF_MOCK_VALS); } \
TEST(suiteName, stringOperatorMove) { queueOperatorMoveTest<std::string>(DEF_STR_VALS); } \
...
TEST(suiteName, uShortFront) { queueFrontTest<unsigned short>(DEF_INT_VALS); } \
TEST(suiteName, intFront) { queueFrontTest<int>(DEF_INT_VALS); } \
TEST(suiteName, doubleFront) { queueFrontTest<double>(DEF_DBL_VALS); } \
TEST(suiteName, MockClassFront) { queueFrontTest<MockClass>(DEF_MOCK_VALS); } \
...
TEST(suiteName, NoConstructClassPush) { queuePushTest<NoConstructClass>(DEF_INT_VALS); } \
...
TEST(suiteName, uShortPushEmpty) { queuePushEmptyTest<unsigned short>(DEF_INT_VALS); } \
TEST(suiteName, intPushEmpty) { queuePushEmptyTest<int>(DEF_INT_VALS); } \
TEST(suiteName, doublePushEmpty) { queuePushEmptyTest<double>(DEF_DBL_VALS); } \
TEST(suiteName, MockClassPushEmpty) { queuePushEmptyTest<MockClass>(DEF_MOCK_VALS); } \
TEST(suiteName, stringPushEmpty) { queuePushEmptyTest<std::string>(DEF_STR_VALS); } \
TEST(suiteName, NoConstructClassPushEmpty) { queuePushEmptyTest<NoConstructClass>(DEF_INT_VALS); } \
...
TEST(suiteName, uShortInsertManyBack) { queueInsertManyqueueBackTest<unsigned short>(DEF_INT_VALS); } \
TEST(suiteName, intInsertManyBack) { queueInsertManyqueueBackTest<int>(DEF_INT_VALS); } \
TEST(suiteName, doubleInsertManyBack) { queueInsertManyqueueBackTest<double>(DEF_DBL_VALS); } \
TEST(suiteName, MockClassInsertManyBack) { queueInsertManyqueueBackTest<MockClass>(DEF_MOCK_VALS); } \
TEST(suiteName, stringInsertManyBack) { queueInsertManyqueueBackTest<std::string>(DEF_STR_VALS); } \
TEST(suiteName, NoConstructClassInsertManyBack) { queueInsertManyqueueBackTest<NoConstructClass>(DEF_INT_VALS); } \
...
TEST(suiteName, uShortInsertManyBackEmpty) { queueInsertManyBackEmptyTest<unsigned short>(DEF_INT_VALS); } \
TEST(suiteName, intInsertManyBackEmpty) { queueInsertManyBackEmptyTest<int>(DEF_INT_VALS); } \
TEST(suiteName, doubleInsertManyBackEmpty) { queueInsertManyBackEmptyTest<double>(DEF_DBL_VALS); } \
TEST(suiteName, MockClassInsertManyBackEmpty) { queueInsertManyBackEmptyTest<MockClass>(DEF_MOCK_VALS); } \
TEST(suiteName, stringInsertManyBackEmpty) { queueInsertManyBackEmptyTest<std::string>(DEF_STR_VALS); } \
TEST(suiteName, NoConstructClassInsertManyBackEmpty) { queueInsertManyBackEmptyTest<NoConstructClass>(DEF_INT_VALS); } \
...
TEST(suiteName, uShortOperatorCopyInitSelt) { queueOperatorInitCopySelfTest<unsigned short>(DEF_INT_VALS); } \
TEST(suiteName, intOperatorCopyInitSelt) { queueOperatorInitCopySelfTest<int>(DEF_INT_VALS); } \
TEST(suiteName, doubleOperatorCopyInitSelt) { queueOperatorInitCopySelfTest<double>(DEF_DBL_VALS); } \
TEST(suiteName, MockClassOperatorCopyInitSelt) { queueOperatorInitCopySelfTest<MockClass>(DEF_MOCK_VALS); } \
TEST(suiteName, stringOperatorCopyInitSelt) { queueOperatorInitCopySelfTest<std::string>(DEF_STR_VALS); } \
...
TEST(suiteName, uShortOperatorMoveSelfInit) { queueOperatorInitMoveSelfTest<unsigned short>(DEF_INT_VALS); } \
TEST(suiteName, intOperatorMoveSelfInit) { queueOperatorInitMoveSelfTest<int>(DEF_INT_VALS); } \
TEST(suiteName, doubleOperatorMoveSelfInit) { queueOperatorInitMoveSelfTest<double>(DEF_DBL_VALS); } \
TEST(suiteName, MockClassOperatorMoveSelfInit) { queueOperatorInitMoveSelfTest<MockClass>(DEF_MOCK_VALS); } \
TEST(suiteName, stringOperatorMoveSelfInit) { queueOperatorInitMoveSelfTest<std::string>(DEF_STR_VALS); } \
